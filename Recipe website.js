...
async function sendMessage() {
  ...
  chatBody.innerHTML += `<div class="user"><span>${message}</span></div>`;
  input.value = "";
  ...
  const data = await response.json();
  chatBody.innerHTML += `<div class="bot"><span>${data.reply}</span></div>`;
  chatBody.scrollTop = chatBody.scrollHeight;
}

// Function to open your chatbot in a popup window
